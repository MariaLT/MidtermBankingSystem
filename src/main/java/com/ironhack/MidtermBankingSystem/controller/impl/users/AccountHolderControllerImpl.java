...
@Autowired
    ...
    @PutMapping("/accountHolders/{id}/address")
    @ResponseStatus(HttpStatus.ACCEPTED)
    public void modifyAddress(@PathVariable Long id, @RequestBody @Valid Address address) {

        accountHolderService.modifyAddress(id, address);
    }
}
