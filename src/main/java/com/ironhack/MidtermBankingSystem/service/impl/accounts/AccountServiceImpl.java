...
public class AccountServiceImpl implements AccountService {
    ...
    public Money accountBalanceOwner(Long idOwner, Long idAccount, String secretKey) {
        ...
        if (account.getSecondaryOwner()!=null && account.getPrimaryOwner().getId() == idOwner || account.getSecondaryOwner().getId() == idOwner
                && account.getSecretKey().equals(secretKey)) {
            return account.getBalance();
        } else if (account.getPrimaryOwner().getId() == idOwner && account.getSecretKey().equals(secretKey)) {
            return account.getBalance();
        } else {
